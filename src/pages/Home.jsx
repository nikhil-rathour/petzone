...
const Home = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#AD49E1] to-[#EBD3F8]">
      <Link 
        to="/story" 
        className="inline-block px-4 py-2 bg-white text-[#AD49E1] font-semibold rounded-full shadow-md hover:bg-[#AD49E1] hover:text-white transition duration-300 ease-in-out m-4"
      >
        Story
      </Link>
      {/* Carousel */}
