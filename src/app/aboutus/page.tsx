...
const AboutUs = () => {
  ...
  const developers = [
    ...
    },
    {
      ...
      linkedin:
        "https://www.linkedin.com/in/realhemantkumar?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app ",
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#AD49E1] to-[#EBD3F8]">
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-8">
          <div className="text-base md:text-lg text-gray-700 leading-relaxed space-y-8">
            <p className="md:leading-loose">
              Welcome to{" "}
              <span className="font-bold text-[#e63579]">PetZone</span>, your
              trusted companion in the world of pet care and adoption. We
              believe that every pet deserves a loving home, and every pet owner
              deserves the best resources and support to care for their furry
              friends.
            </p>
            <p className="md:leading-loose">
              At <span className="font-bold text-[#e63579]">PetZone</span>, we
              offer a comprehensive platform that connects pet lovers, adopters,
              and sellers, making the process of finding, adopting, or selling
              pets as smooth as possible. Whether you&apos;re looking for advice on
              pet care, searching for the perfect pet food, or hoping to adopt a
              new family member, PetZone is here to guide you every step of the
              way.
            </p>

            <div className="bg-[#F2AFEF] bg-opacity-20 p-6 rounded-lg shadow-md">
              <h3 className="text-3xl font-bold text-[#e63579] mb-4">
                Our Mission:
              </h3>
              <ul className="list-disc list-inside space-y-3 text-gray-800">
                <li>
                  To create a community where pets and their owners can thrive.
                </li>
                <li>To provide valuable resources and tips for pet care.</li>
                <li>
                  To support the adoption of pets, ensuring they find loving
                  homes.
                </li>
                <li>
                  To offer a platform where pet owners can connect, share, and
            ...
            <div className="bg-[#C499F3] bg-opacity-20 p-6 rounded-lg shadow-md">
              ...
              <ul className="list-disc list-inside space-y-3 text-gray-800">
                <li>
                  <span className="font-bold text-[#e63579]">
                    Comprehensive Resources:
                  </span>{" "}
                  From pet food to care tips, we&apos;ve got everything you need.
                </li>
                <li>
                  <span className="font-bold text-[#e63579]">
                    Community Support:
                  </span>{" "}
                  Join a community of pet lovers who share your passion.
                </li>
                <li>
                  <span className="font-bold text-[#e63579]">
                    Easy Adoption Process:
                  </span>{" "}
                  Simplify the process of finding and adopting your next pet.
                </li>
                <li>
                  <span className="font-bold text-[#e63579]">
                    Trusted Sellers:
                  </span>{" "}
                  Connect with reputable sellers who care about the well-being
                  of their pets.
                </li>
              </ul>
            </div>
            ...
            <p className="mt-10 text-lg font-medium text-gray-800 text-center">
              Join us at{" "}
              <span className="font-bold text-[#e63579]">PetZone</span>, where
              we bring pet lovers and their beloved companions together in a
              caring, supportive, and informed environment. Let&apos;s make every
        ...
        <div className="mt-12 max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-8">
          <h2 className="text-3xl font-bold text-[#e63579] mb-8 text-center">
            Meet Our Development Team
          </h2>
          <p className="text-center text-gray-600 mb-10 text-lg">
            The talented developers behind PetZone who made this platform
            possible
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {developers.map((developer, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-[#F2AFEF] to-[#C499F3] bg-opacity-20 rounded-lg p-6 text-center hover:shadow-lg transition-shadow duration-300"
              >
                ...
                <h3 className="font-bold text-[#e63579] text-lg mb-2">
                  {developer.name}
                </h3>
