  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
      <div className="relative h-48">
        <Image className="w-full h-full object-cover" src={pet.image} alt={pet.name} width={500} height={500}/>
...
const petData = [
  ...
  {
    image: "https://as1.ftcdn.net/v2/jpg/03/66/46/22/1000_F_366462268_7nWKE6SfNRZCp8tC5mnewUOibXIE9nw6.jpg",
